...
#include "../qtquick1applicationviewer/qtquick1applicationviewer.h"
...
struct qt_meta_stringdata_QtQuick1ApplicationViewer_t {
    QByteArrayData data[1];
    char stringdata[26];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QtQuick1ApplicationViewer_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QtQuick1ApplicationViewer_t qt_meta_stringdata_QtQuick1ApplicationViewer = {
    {
QT_MOC_LITERAL(0, 0, 25) // "QtQuick1ApplicationViewer"

    },
    "QtQuick1ApplicationViewer"
};
...
const QMetaObject QtQuick1ApplicationViewer::staticMetaObject = {
    { &QDeclarativeView::staticMetaObject, qt_meta_stringdata_QtQuick1ApplicationViewer.data,
      qt_meta_data_QtQuick1ApplicationViewer,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtQuick1ApplicationViewer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtQuick1ApplicationViewer.stringdata))
